  ...
  return (
    <div className={cn("relative block md:hidden", className)}>
      ...
      <button
        ...
        className="border border-gray-500 flex h-10 w-10 items-center justify-center rounded-full bg-gray-50">
...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "mx-auto hidden h-16 items-end gap-4 rounded-4xl bg-[rgb(255,252,235)] px-8 pb-3 md:flex",
        className
      )}>
      {items.map((item) => (
  ...
  return (
    <Link href={href}>
      <motion.div
        ...
        className="relative flex aspect-square items-center justify-center rounded-full bg-yellow-100">
        <AnimatePresence>
          {hovered && (
            <motion.div
